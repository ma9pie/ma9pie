  ...
  return (
    <>
      ...
      <Text.P>
        ...
        분리해야겠다는 필요성이 생겨 useReducer를 활용 하여 로직을 분리하고
      ...
      <Text.P>
        ...
        업데이트 할때 새로운 배열 주소로 Redux state를 할당해서 Price가 업데이트
        될때마다 리스트 전체가 렌더링되는 문제를 발견하여 해결하였고, 화면상으로
        보이는 부분만 렌더링할 수 있도록 react-window 리스트 가상화 라이브러리를
        사용하여 최적화를 하였습니다.
      </Text.P>
      <Text.P>
        ...
        transform 속성 사용을 통해서 해당 문제를 해결할 수 있었습 니다
      </Text.P>
