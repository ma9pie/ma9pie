    ...
    <Content>
      ...
      <div>
        ...
        <Text.P>
          ...
          개발 공부를 하면서 배웠던 내용(TIL)을 기록하기 위함이었고, 주로
          알고리즘 문제 풀이 과정과 설명에 대한 내용을 포스팅하였습니다. 현재 총
          850개 이상의 게시글과 누적 방문자 수 200만 이상을 기록하고 있으며,
          시간 날 때마다 실무를 하면서 마주한 에러를 해결했던 내용이나 새롭게
          알게 된 사실에 대해 포스팅을 하고 있습니다.
        </Text.P>
        <Text.P>
